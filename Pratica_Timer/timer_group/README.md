...
São mostrados os tempos para o acontecimento do evento e da task dos timers com e sem a configuração de auto-reload. É possível observar que existe um tempo até a execução da task e o acontecimento da interrupção (evento).
